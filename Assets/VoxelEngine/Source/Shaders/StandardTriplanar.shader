...
Shader "Standard Triplanar"
{
    ...
    SubShader
    {
        ...
        void surf(Input IN, inout SurfaceOutputStandard o)
        {
            ...
            float factor = dot(IN.localNormal, float3(0, 1, 0));
            ...
            // Base color
            half4 cx = tex2D(_SideTex, tx);
            half4 cy = tex2D(_MainTex, ty) * _Color;
            half4 cz = tex2D(_SideTex, tz);
            half4 color = (cy + cz) * _Color;
            //o.Albedo = color.rgb;
            o.Alpha = color.a;
